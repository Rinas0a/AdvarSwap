...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and ADVAR pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and ADVAR pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from ADVAR pool', data)
  }
