...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'ADVAR card' },
    { src: 'green', alt: 'Green ADVAR card with up arrow' },
    { src: 'red', alt: 'Red ADVAR card with down arrow' },
    { src: 'top-right', alt: 'ADVAR card' },
  ],
}
